...
let playerCards = []
let houseCards = []
let nextCard, valueNextCard, sumPlayer, sumHouse, houseFirstDraw, houseSecondDraw;
...
const jokerImg1 = document.createElement("img")
const jokerImg2 = document.createElement("img")
let userCardsDiv = document.getElementById('user-cards')
...
const houseFirstCard = document.getElementById('house-card-1')
const houseSecondCard = document.getElementById('house-card-2')
let houseCardsDiv = document.getElementById('house-cards-grid')
