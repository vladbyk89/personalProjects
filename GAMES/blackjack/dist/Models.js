var NewCard = /** @class */ (function () {
    ...
    NewCard.prototype.getRndmCard = function () {
        var cardIndex = Math.floor(Math.random() * copyDeck.length);
        var card = copyDeck[cardIndex];
        //remove card from deck
        copyDeck.splice(cardIndex, 1);
        return card;
    };
    NewCard.prototype.getCardValue = function (aCard) {
    ...
    NewCard.prototype.returnImgLink = function (aCard) {
